...
// Changes were performed to keep retrocompability with Go-Ethereum v1.10.17 abigen version
// This is distributed under same GNU General Public License version 3
...
var (
	...
	//TODO: restore and setup vyper usage
	/*
...
func init() {
	app = newApp("abigen-golang - Golang Proxy generator for Ethereum Virtual Machine Smart Contracts")
	app.Flags = []cli.Flag{
		abiFlag,
		binFlag,
		typeFlag,
	...
	if c.GlobalString(abiFlag.Name) != "" {
		...
		/*
			case c.GlobalIsSet(vyFlag.Name):
				...
				if err != nil {
					log.Fatalf("Failed to build Vyper contract: %v", err)
				}
